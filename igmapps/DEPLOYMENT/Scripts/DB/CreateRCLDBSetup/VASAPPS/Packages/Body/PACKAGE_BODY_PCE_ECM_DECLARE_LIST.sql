CREATE OR REPLACE PACKAGE BODY VASAPPS.PCE_ECM_DECLARE_LIST AS
...
/*
    ...
    *18: Modified by Thitikul, substr description to 70 characters when call package PRC_INSERT_TEXT, 24.06.2014 
     ...
     /* End add by Chatgamol*/
        ...
        IF (l_rec_edi_data.VENTILATION <> 0) THEN
            PKG_EDI_DOCUMENT.PRC_INSERT_TEXT(
                ...
                , NULL -- l_n_edi_esdco_seq
                , 'OSI'
                , SUBSTR(l_rec_edi_data.VENTILATION || NVL(SUBSTR(l_rec_edi_data.PUBLIC_REMARK, 1, 3), 'M'),0,70) --##18 
                , NULL
                , g_v_upd_by_edi
                , l_n_edi_esde_seq
            );
        ...
        PKG_EDI_DOCUMENT.PRC_INSERT_TEXT(
            ...
            , NULL -- l_n_edi_esdco_seq
            , 'CON'
            , SUBSTR(l_rec_edi_data.LOCAL_TERMINAL_STATUS,0,70) --##18 
            , NULL
            , g_v_upd_by_edi
            , l_n_edi_esde_seq
        );
...
--                 );
        ...
        IF l_v_cont_ld_rem_desc1 IS NOT NULL THEN
            ...
            PKG_EDI_DOCUMENT.PRC_INSERT_TEXT(
                ...
                , NULL
                , 'CLR'
                , SUBSTR(l_v_cont_ld_rem_desc1,0,70) --##18 
        ...
        IF l_v_cont_ld_rem_desc2 IS NOT NULL THEN
            ...
            PKG_EDI_DOCUMENT.PRC_INSERT_TEXT(
                ...
                , NULL
                , 'CLR'
                , SUBSTR(l_v_cont_ld_rem_desc2,0,70) --##18 
                    ...
                    , NULL
                      ...
                      LOOP
                         ...
                         pkg_edi_document.prc_insert_text (l_v_edi_etd_uid,
                                                           ...
                                                           l_n_edi_esdco_seq,
                                                           'AAI'
                                                           ,SUBSTR(l_cur_idp060_data.FYDSCR,0,70)  --##18 
                                                           ,l_cur_idp050_data.BYCMCD,
                                                           g_v_upd_by_edi,
                                                           l_n_edi_esde_seq
                                                          );
                        ...
                        WHERE EYBLNO = l_v_bill_of_lading
                         ...
                         THEN
                                ...
                                INSERT INTO EDI_ST_DOC_HAZARD (
                                    ...
                                    , TRIM (l_cur_idp051_data.IYMPRO)--l_rec_edi_data.T_IMDG
                                    --, l_v_haz_mat_sub_class
                                    , LPAD (l_cur_idp051_data.IYIUNO, 4, '0')--SUBSTR(l_rec_edi_data.T_UNNO,1,4)
                            ...
                            THEN
                               ...
                               pkg_edi_document.prc_insert_text (l_v_edi_etd_uid,
                                                                 ...
                                                                 l_n_edi_esdco_seq,
                                                                 'AAC'
                                                                 ,SUBSTR(l_cur_idp051_data.IYHZDS,0,70)  --##18 
                                                                 ,NULL,
                                                                 g_v_upd_by_edi,
                                                                 l_n_edi_esde_seq
                                                                );
                            ...
                            THEN
                               ...
                               pkg_edi_document.prc_insert_text
                                                  (l_v_edi_etd_uid,
                                                   ...
                                                   l_n_edi_esdco_seq,
                                                   'AAD'
                                                   ,SUBSTR(l_cur_idp051_data.PROPER_SHIPPING_NAME,0,70)  --##18 
                                                   ,NULL,
                                                   g_v_upd_by_edi,
                                                   l_n_edi_esde_seq
                                                  );
                      ...
                      INSERT INTO EDI_ST_DOC_COMMODITY(
                        ...
                        VALUES (l_n_edi_esdco_seq, l_n_edi_esde_seq
                         ...
                         PKG_EDI_DOCUMENT.PRC_INSERT_TEXT (l_v_edi_etd_uid,
                                                           ...
                                                           l_n_edi_esdco_seq,
                                                           'AAA'
                                                           ,SUBSTR(l_cur_bkp050_data.COMM_DESC,0,70)  --##18 
                                                           ,l_cur_bkp050_data.BWCMCD,
                                                           g_v_upd_by_edi,
                                                           NULL -- l_n_edi_esde_seq modified by vikas, as k'chatgamol say no need, 29.11.2011
                                                          );
                                ...
                                g_v_sql_id := '75q';
                                 ...
                                 INSERT INTO EDI_ST_DOC_HAZARD
                                      ...
                                      VALUES (l_n_edi_esdco_seq, l_v_edi_esdh_seq,
                                              ...
                                              TRIM (l_v_imo_class), l_v_imo_label,
                                              l_v_undg_no, l_v_mfag_no, l_v_ems_no,
                                              l_v_marine_pollutant, l_v_residue,
                                 ...
                                 THEN
                                    ...
                                    pkg_edi_document.prc_insert_text (l_v_edi_etd_uid,
                                                                      ...
                                                                      l_n_edi_esdco_seq,
                                                                      'AAC'
                                                                      ,SUBSTR(l_v_hz_description,0,70)  --##18 
                                                                      ,NULL,
                                                                      g_v_upd_by_edi,
                                                                      l_n_edi_esde_seq
                                                                     );
                                 ...
                                 THEN
                                    ...
                                    pkg_edi_document.prc_insert_contact
                                                                       (l_v_edi_etd_uid,
                                                                        ...
                                                                        l_v_edi_esdh_seq,
                                                                        'HG'
                                                                        ,SUBSTR(l_v_contact_person,0,70)  --##18 
                                                                        ,NULL,
                                                                        g_v_upd_by_edi,
                                                                        l_n_edi_esdcn_seq
                                                                       );
...
EXCEPTION
    WHEN l_e_exception THEN
        ...
        IF g_v_sql_id <> '71' THEN
            ...
            p_o_v_err_cd := g_v_sql_id || '~' ||'Error Occured during EDI generation.';
