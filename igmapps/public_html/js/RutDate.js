...
function compareDate(strEffDate,strExpDate,strDateFormat){
    ...
    var strYear2="";
        ...
        if(strDateFormat==2){
            strMonth1  = strEffDate.substring(0,2);
            strDate1 = strEffDate.substring(3,5);
            strYear1  = strEffDate.substring(6,10);

            strMonth2  = strExpDate.substring(0,2);
            strDate2 = strExpDate.substring(3,5);
            strYear2  = strExpDate.substring(6,10);
	}else if(strDateFormat==1){
            strDate1  = strEffDate.substring(0,2);
            strMonth1 = strEffDate.substring(3,5);
            strYear1  = strEffDate.substring(6,10);

            strDate2  = strExpDate.substring(0,2);
            strMonth2 = strExpDate.substring(3,5);
            strYear2  = strExpDate.substring(6,10);
         }else{
            strDate1  = strEffDate.substring(8,10);
            strMonth1 = strEffDate.substring(5,7);
            strYear1  = strEffDate.substring(0,4);

            strDate2  = strExpDate.substring(8,10);
            strMonth2 = strExpDate.substring(5,7);
            strYear2  = strExpDate.substring(0,4);
	}

    var intStartDate=strYear1+strMonth1+strDate1;
    var intEndDate=strYear2+strMonth2+strDate2; 
...
calendar.prototype.show = function() {
    ...
    this.wwrite("<link rel='stylesheet' type='text/css' href='/" + appCtxPath + "/css/calendar.css'>");
    this.wwrite("</head>");
...
//    this.wwrite("</table>");
    ...
    this.wwrite("<TR>");
    this.wwrite("<TD class=CalendarTitle><div align='center'><A HREF=\"" + "javascript:window.opener.build(" + "'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)-1) + "', '" + this.gFormat + "'" + ");" + "\"><img src='/" + appCtxPath + "/images/btnArrowFirst.gif' width='17' height='14' border='0' align='absmiddle' alt='Prev Year'></A></div></TD>");
    this.wwrite("<TD class=CalendarTitle><div align='center'><A HREF=\"" + "javascript:window.opener.build(" + "'" + this.gReturnItem + "', '" + prevMM + "', '" + prevYYYY + "', '" + this.gFormat + "'" + ");" + "\"><img src='/" + appCtxPath + "/images/btnArrowBack.gif' width='15' height='14' border='0' align='absmiddle' alt='Prev Month'></A></div></TD>");
    this.wwrite("<TD class=CalendarTitle><div align='center'>");
    this.wwriteA(this.gMonthName + " " + this.gYear);
    this.wwriteA("</div></TD>");
    this.wwrite("<TD class=CalendarTitle><div align='center'><A HREF=\"" + "javascript:window.opener.build(" + "'" + this.gReturnItem + "', '" + nextMM + "', '" + nextYYYY + "', '" + this.gFormat + "'" + ");" + "\"><img src='/" + appCtxPath + "/images/btnArrowNext.gif' width='15' height='14' border='0' align='absmiddle' alt='Next Month'></A></div></TD>");
    this.wwrite("<TD class=CalendarTitle><div align='center'><A HREF=\"" + "javascript:window.opener.build(" + "'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)+1) + "', '" + this.gFormat + "'" + ");" + "\"><img src='/" + appCtxPath + "/images/btnArrowEnd.gif' width='17' height='14' border='0' align='absmiddle' alt='Next Year'></A></div></TD>");
    this.wwrite("</TR>");
    this.wwrite("</TABLE>")
...
//    this.wwrite("</table>");     
    ...
    this.wwrite("<TABLE width='220' BORDER=0 CELLPADDING='0' CELLSPACING='0' BGCOLOR='#ffffff'>");
    this.wwrite("<TR>");
    this.wwrite("<TD class=CalendarTitle><div align='center'><A HREF=\"" + "javascript:window.opener.build(" + "'" + this.gReturnItem + "', null, '" + prevYYYY + "', '" + this.gFormat + "'" + ");" + "\"><img src='/" + appCtxPath + "/images/btnArrowFirst.gif' width='17' height='14' border='0' align='absmiddle' alt='Prev Year'></A></div></TD>");
    this.wwrite("<TD class=CalendarTitle><div align='center'>");
    this.wwrite("Year : " + this.gYear);
    this.wwriteA("</div></TD>");
    this.wwrite("<TD class=CalendarTitle><div align='center'><A HREF=\"" + "javascript:window.opener.build(" + "'" + this.gReturnItem + "', null, '" + nextYYYY + "', '" + this.gFormat + "'" + ");" + "\"><img src='/" + appCtxPath + "/images/btnArrowEnd.gif' width='17' height='14' border='0' align='absmiddle' alt='Next Year'></A></div></TD>");
    this.wwrite("</TR>");
    this.wwrite("</TABLE>")    
