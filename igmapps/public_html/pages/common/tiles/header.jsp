...
<tr>
    <td width="40%" class="PageTitle"><%=lstrScreenHeading%> (Cloud)</td> 
    <td width="60%" class="PageTitleRight">
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
            <td width="15%" valign="middle" align="right"><font size="1" face="Verdana" color="#FFFFFF"></font></td>
            <td width="70%" valign="middle" align="right"><font size="1" face="Verdana" color="#FFFFFF"><%=account.getUserName()+" ("+account.getUserId()+")"%>-&nbsp;<%=account.getUserFsc()%>&nbsp;-&nbsp;<%=account.getFscAccessLevels()%>&nbsp;<%=account.getDateFormat()%></font></td>
            <td valign="middle" align="left"><img border="0" src="<%=lstrCtxPath%>/images/imgDivider.gif" height="20"></td>
            <%if (hasBack) {%>		
                <td valign="middle" align="right">
                    <a href="javascript:onBack();"><img border="0" alt="Back" src="<%=lstrCtxPath%>/images/btnBack.jpg"></a>
                </td>
                <td valign="middle" align="center"><img border="0" src="<%=lstrCtxPath%>/images/imgDivider.gif" height="20"></td>
            <%}%>
            <%if (hasRefresh) {%>
                <td valign="middle" align="right">
                    <a href="javascript:onResetForm();"><img border="0" alt="Refresh" src="<%=lstrCtxPath%>/images/btnRefresh.jpg"></a>
                </td>
                <td valign="middle" align="center"><img border="0" src="<%=lstrCtxPath%>/images/imgDivider.gif" height="20"></td>
            <%}%>
            <%if (hasSave) {%>
                <td valign="middle" align="right">
                    <a href="javascript:onSave();"><img border="0" alt="Save" src="<%=lstrCtxPath%>/images/btnSave.jpg"></a>
                </td>
                <td valign="middle" align="center"><img border="0" src="<%=lstrCtxPath%>/images/imgDivider.gif" height="20"></td>
            <%}%>
